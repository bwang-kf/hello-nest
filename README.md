...
# start postgres using volume
$ docker run --name my-postgres -e POSTGRES_PASSWORD=password -d -p 5432:5432 --mount source=postgres-data,destination=/var/lib/postgresql/data postgres
